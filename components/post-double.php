    ...
    <div class="col-md-6">
        <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
                ...
                <h3 class="mb-0">
                    <a class="text-dark" href=" #"><?= decode($cardLeftTitle) ?></a>
                </h3>
                <div class="mb-1 text-muted">Nov 12</div>
                <p class="card-text mb-auto"><?= $cardLeftText ?></p>
    ...
    <div class="col-md-6">
        <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
                ...
                <h3 class="mb-0">
                    <a class="text-dark" href=" #"><?= decode($cardRightTitle) ?></a>
                </h3>
                <div class="mb-1 text-muted">Nov 11</div>
                <p class="card-text mb-auto"><?= $cardRightText ?></p>
                <a href=" #">Continue reading</a>
            </div>
